...
const ChatHeader = () => {
  return (
    <section className="sticky top-0 flex flex-col justify-center items-center w-full h-[10.2rem] border-0 border-b-solid border-b border-b-[rgba(0, 0, 0, 0.25)] mb-0">
